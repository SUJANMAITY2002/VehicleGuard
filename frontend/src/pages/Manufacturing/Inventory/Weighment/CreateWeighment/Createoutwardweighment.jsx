...
const CreateOutwardWeighment = () => {
  ...
  const getItemWeight = (rowIdx) => {
    setItems((prev) => {
      ...
      if (row.secondLocked) { alert("Second weight already recorded for this row."); return prev; }
                  ...
                  {ginResults.map((row, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td>
                          {isEditing ? ginCell("billNo") : row.billNo || "-"}
                        </td>
      ...
      <div className="ciw-card">
        ...
        <div className="ciw-form-grid">
          ...
          <div className="ciw-field">
            ...
            <input value="Outward" readOnly className="ciw-readonly" />
          </div>
